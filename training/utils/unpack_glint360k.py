...
if __name__ == '__main__':
    ...
    # general
    parser.add_argument('--include', default='/data/fboutros/glink/glint360k', type=str, help='')
    parser.add_argument('--output', default='/data/fboutros/glink/images', type=str, help='')
